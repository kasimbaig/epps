...
export class SararMainComponentComponent implements OnInit {
  ...
  toggleReportsDropdown(): void {
    console.log('toggleReportsDropdown called');
    console.log('Before toggle - showReportsDropdown:', this.showReportsDropdown);
    this.showReportsDropdown = !this.showReportsDropdown;
    console.log('After toggle - showReportsDropdown:', this.showReportsDropdown);
    this.showTransactionsDropdown = false; // Close other dropdown
  ...
  onClickOutside(event: Event) {
    ...
    if (!target.closest('.masters-dropdown-container') && !target.closest('.transactions-dropdown-container') && !target.closest('.reports-dropdown-container')) {
      this.showMasterDropdown = false;
      this.showTransactionsDropdown = false;
      this.showReportsDropdown = false;
    }
