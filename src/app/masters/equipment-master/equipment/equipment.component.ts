   ...
   staticEquipmentData = [
    {
      ...
      country_name: 'USA',
      supplier_name: 'NavalSupply Co',
      group: { name: 'Electronics', section_name: 'Navigation' },
      type_name: 'Communication',
      active: true,
      generic_code: 'GC001',
      maintop_number: 'MT001',
      acquaint_issued: 'AI001',
      authority: 'Naval Command',
      ilms_equipment_code: 'ILMS001',
      obsolete: false,
      total_fits: '5',
    ...
    },
    {
      id: 2,
      code: 'EQ002',
      name: 'Sonar Equipment',
      model: 'SE-2023',
      manufacturer_name: 'SonarTech',
      country_name: 'Germany',
      supplier_name: 'Marine Equipment Ltd',
      group: { name: 'Detection', section_name: 'Underwater' },
      type_name: 'Detection',
      active: true,
      generic_code: 'GC002',
      maintop_number: 'MT002',
      acquaint_issued: 'AI002',
      authority: 'Naval Command',
      ilms_equipment_code: 'ILMS002',
      obsolete: false,
      total_fits: '3',
    ...
    },
    {
      ...
      model: 'ECS-2022',
      manufacturer_name: 'PowerSystems',
      country_name: 'Japan',
      supplier_name: 'Industrial Motors',
      group: { name: 'Propulsion', section_name: 'Engine' },
      type_name: 'Control',
      active: true,
      generic_code: 'GC003',
      maintop_number: 'MT003',
      acquaint_issued: 'AI003',
      authority: 'Engineering Division',
      ilms_equipment_code: 'ILMS003',
      obsolete: false,
      total_fits: '2',
    ...
    },
    {
      ...
      model: 'CA-2024',
      manufacturer_name: 'CommTech',
      country_name: 'UK',
      supplier_name: 'Defense Communications',
      group: { name: 'Communication', section_name: 'Radio' },
      type_name: 'Communication',
      active: true,
      generic_code: 'GC004',
      maintop_number: 'MT004',
      acquaint_issued: 'AI004',
      authority: 'Communications Office',
      ilms_equipment_code: 'ILMS004',
      obsolete: false,
      total_fits: '4',
    ...
    },
    {
      ...
      model: 'NC-2023',
      manufacturer_name: 'NaviSystems',
      country_name: 'France',
      supplier_name: 'Navigation Solutions',
      group: { name: 'Navigation', section_name: 'Bridge' },
      type_name: 'Computer',
      active: true,
      generic_code: 'GC005',
      maintop_number: 'MT005',
      acquaint_issued: 'AI005',
      authority: 'Navigation Department',
      ilms_equipment_code: 'ILMS005',
      obsolete: true,
      total_fits: '1',
      ship_applicable: 'Corvette'
    }
  ];
  goBack() {
    this.location.back();
