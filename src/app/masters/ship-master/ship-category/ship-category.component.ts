...
const STATIC_SHIP_CATEGORIES: any[] = [
  { id: 1,  active: 1, code: 'AC',   name: 'AIRCRAFT CARRIERS',          created_by: '1' },
  { id: 2,  active: 1, code: 'SSN',  name: 'NUCLEAR SUBMARINES',         created_by: '1' },
  { id: 3,  active: 1, code: 'FFG',  name: 'GUIDED MISSILE FRIGATES',    created_by: '2' },
  { id: 4,  active: 1, code: 'LPD',  name: 'AMPHIBIOUS DOCK SHIPS',      created_by: '2' },
  { id: 5,  active: 1, code: 'AOR',  name: 'FLEET TANKERS',              created_by: '3' },
  { id: 6,  active: 1, code: 'MCMV', name: 'MINE COUNTERMEASURE VESSELS', created_by: '3' },
  { id: 7,  active: 1, code: 'OPV',  name: 'OFFSHORE PATROL VESSELS',    created_by: '4' },
  { id: 8,  active: 1, code: 'SV',   name: 'SURVEY SHIPS',               created_by: '4' },
  { id: 9,  active: 1, code: 'TS',   name: 'TRAINING SHIPS',             created_by: '5' },
  { id: 10, active: 1, code: 'LST',  name: 'LANDING SHIP TANKS',         created_by: '5' },
];
