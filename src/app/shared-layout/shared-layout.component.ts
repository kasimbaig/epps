...
toggleDownloadMenu() {
  ...
  const urls = {
    pdf: 'https://cmms-api.ilizien-projects-cdf.in/media/ppt/EPPS-CMMA_updated.pdf',
    pptx: 'https://cmms-api.ilizien-projects-cdf.in/media/ppt/EPPS-CMMA_updated.pptx'
  };
